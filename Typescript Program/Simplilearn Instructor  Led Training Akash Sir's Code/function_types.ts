...
function studentInfo(sId:number=0,sName:string="Unknown",age:number=7){
...
// In one function, we can only use one rest operator/parameter and it must be the last parameter in function 
