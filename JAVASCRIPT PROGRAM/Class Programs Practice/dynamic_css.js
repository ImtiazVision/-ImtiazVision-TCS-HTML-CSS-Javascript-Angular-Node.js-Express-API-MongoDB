...
function cssEffect() {
  ...
  document.getElementById("dd").style.fontSize="30px";
  document.getElementById("obj1").style.backgroundColor="RED";
  document.getElementById("imgId").src ="https://media.gettyimages.com/photos/fruits-and-vegetables-vegetarian-food-on-rustic-wood-board-picture-id1222380854?k=6&m=1222380854&s=612x612&w=0&h=TORaBT4xcZ5h77qA1iJwdexD7Vai9dYPtSICl1R-1kU="} else {
  document.getElementById("obj1").style.color="BLUE";
  document.getElementById("obj1").src.backgroundColor="RED";
